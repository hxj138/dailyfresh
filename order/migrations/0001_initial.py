# Generated by Django 2.1.3 on 2019-07-15 00:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.SmallIntegerField(choices=[(1, '货到付款'), (2, '微信支付'), (3, '支付宝'), (4, '银联支付'), (5, '已完成')], default=1, verbose_name='订单状态')),
